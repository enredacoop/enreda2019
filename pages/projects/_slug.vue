              ...
              <div class="row">
                ...
                >
                  ...
                  >
                    <img
                      :src="technology.logo"
                      :alt="'Logo de ' + technology.technology"
          ...
          <div class="container wow fadeInUp">
            <div class="row">
              <div class="col-sm-12 text-center">
                <h4>Algunas apariciones en medios</h4>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              ...
              >
                <div :class="'media ' + media.class">
                  <img
                    :src="'~/assets/images/media/' + media.image"
      ...
      projects: [
...

        {
          ...
          keys: [
            ...
            {
              key:
                "Transparencia para facilitar la donación de materiales a ONG's."
            },
            {
              key:
...

        {
          ...
          sourcecode:
            'https://github.com/enredacoop/transparencia-presupuestaria',
          keys: [
...

        {
          ...
          metrics: [
            ...
            {
              metric:
                'Diseño de Hoja de Ruta para la participación en Andalucía',
              value: ' '
            }
          ],
          metricsinfo: 'Datos obtenidos en 2018',

...
export const state = () => ({
  items: [
    ...
    {
      id: 'villalba',
      title: 'Villalba Project - Safe School Road',
      class: 'villalba',
      subtitle: `Programme of actions for the promotion of sustainable mobility in Villalba de Alcor`,
      body: `
      <p>
      These actions are linked to the urban redevelopment and redesign that the City Council has carried out around the CEIP Francisco Alcalá school to promote non-motorised transports. These works are part of the programme of subsidies for projects of local entities that favour the transition to a low-carbon economy, 80% co-financed by the European Regional Development Fund (ERDF) in the framework of the multiregional operational programme for Spain 2014-2020.</p>
      <p>
      To this end, Enreda has developed a programme to promote a school route through training and education activities on mobility, promoting sustainable mobility towards CEIP Francisco Alcalá, enhancing transit mobility (pedestrian and cycling), creating a safe, accessible and attractive itinerary.</p>
      <p>
      </p>
      <p>This programme has included informative actions aimed at the entire population of Villalba de Alcor. Participatory activities were aimed at the residents of the streets affected by the works and activities intended for the school population of CEIP Francisco Alcalá.
      The icing on the cake of this programme took place last November when the works were complete.  We made a tour through the renovated streets with the pupils and a mural with the collaboration of Estudio 96 to promote sustainable mobility on the roundabout on the access to the school. The mural represents a diverse group of children walking or cycling to school and is crowned by a slogan, which was chosen by the school students in a participatory process.   </p>
      `,
      description: `
      ENREDA has developed for the Villalba de Alcor Town Council an intense programme of actions to promote sustainable mobility in the surroundings of the CEIP Francisco Alcalá.`,
      ...
      technologies: [],
      keys: [
        { key: 'Participatory Action Research (PAR)' },
        { key: 'Surveys' },
        { key: 'Workshops' }
      ],
      media: [],
      own: 'no',
      clientname: 'Villalba de Alcor City Council',
      clientdescription: '',
